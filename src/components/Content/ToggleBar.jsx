...
const ToggleBar = ({ assets, theme, onThemeToggle }) => {
    ...
    return (
        <div className="fixed top-12 right-12 z-12 pointer-events-auto flex items-center">
            <div className="flex items-center justify-center text-[#222222] dark:text-[#f1eee4] mx-[10px]">
